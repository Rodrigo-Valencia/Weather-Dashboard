...
searchButton.click(function () {
    ...
    if (searchInput == "") {
        ...
        $.ajax({
            ...
            currentName.append('<img scr="https://openweathermap.org/img/wn/${response.weather[0].icon}@2x.png">');
            ...
            var urlUV = 'https://api.openweathermap.org/data/2.5/uvi?appid=574c084447b2b4671be2b341b79a66d0&lat=${response.coord.lat}&lon=${response.coord.lon';
